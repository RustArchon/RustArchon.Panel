...
public class ApplicationUser : IdentityUser<Guid>, IUser
{
    ...
    //
    // A person's own settings (their language) are not here: they live in RustArchon.Api's UserProfile, which the Api can read and this database is not
    // visible to. See UserProfileWriter.
}
